...
固定脚本：`.agents/skills/value-report/render_value_report_charts.py`
...
```bash
uv run python .agents/skills/value-report/render_value_report_charts.py <草稿md路径> --inject-report <正式报告md路径> --cleanup-intermediate
```
...
uv run python .agents/skills/value-report/render_value_report_charts.py \
  outputs/reports/300232_洲明科技/value_300232_洲明科技_2604151509_draft.md \
  --inject-report outputs/reports/300232_洲明科技/value_300232_洲明科技_2604151509.md --cleanup-intermediate
```
